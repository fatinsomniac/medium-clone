    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav ms-auto me-5 mb-2 mb-lg-0">
        <li class="nav-item me-3">
          <a class="nav-link {{ (request()->is('ourstory*')) ? 'active' : '' }}" href="{{ route('ourstory') }}">
            Our Story
          </a>
        </li>
        <li class="nav-item me-3">
          <a class="nav-link {{ (request()->is('membership*')) ? 'active' : '' }}" href="{{ route('membership') }}">
            Membership
          </a>
        </li>
        <li class="nav-item me-3">
        ...
        <li class="nav-item me-3">
          <a class="nav-link {{ (request()->is('signin*')) ? 'active' : '' }}" href="{{ route('signin') }}">
            Sign In
          </a>
        </li>
        <li class="nav-item me-3">
